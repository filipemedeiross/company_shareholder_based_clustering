...
class CursorPage(Page):
    def __init__(self, obj_list, has_next, has_previous, next_cursor, prev_cursor):
        super().__init__(obj_list, number=None, paginator=None)
    ...
    def page(self, after=None, before=None):
        ...
        if items:
            if after:
                ...
                next_cursor = getattr(items[-1], self.ordering)
